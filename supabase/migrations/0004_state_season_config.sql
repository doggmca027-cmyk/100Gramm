-- Expose season.config in get_player_state so the client can derive
-- slot-progression math (base_slots/cycles_per_slot/max_slots) itself
-- instead of us hardcoding another RPC field per season.
