...
const en: typeof ru = {
  ...
  bank: {
    ...
    matured: "Term is over",
    statusClaimed: "Claimed",
    statusEarlyClosed: "Closed early",
    buffSpeed: "+10% cycle speed",
    buffSlot: "+1 slot",
    claim: "Claim",
    earlyWithdraw: "Withdraw early, no yield",
    earlyWithdrawConfirm: "Withdraw early? The yield is lost, and any active buffs (slot/speed) drop immediately.",
    actionFailed: "Couldn't complete the action, please try again",
    notMaturedYet: "The term isn't over yet",
    alreadyResolved: "This deposit is already closed",
  },
  partnerTasks: {
