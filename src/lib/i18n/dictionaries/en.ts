...
const en: typeof ru = {
  ...
  shop: {
    navLabel: "Buy GRAM",
    title: "💎 GRAM Shop",
    subtitle: "Top up your balance with TON",
    connectWallet: "Connect a wallet to buy",
    buy: "Buy for {price} TON",
    preparing: "Preparing your purchase...",
    awaitingWallet: "Confirm in your wallet...",
    verifying: "Verifying payment on-chain...",
    success: "Done! Your balance was topped up by {amount} GRAM",
    close: "Close",
    cancelled: "Payment cancelled",
    errorGeneric: "Couldn't complete the purchase — try again",
