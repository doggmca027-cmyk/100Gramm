...
const id: typeof ru = {
  ...
  bank: {
    ...
    matured: "Masa berakhir",
    statusClaimed: "Diambil",
    statusEarlyClosed: "Ditutup lebih awal",
    buffSpeed: "+10% kecepatan siklus",
    buffSlot: "+1 slot",
    claim: "Ambil",
    earlyWithdraw: "Tarik lebih awal, tanpa bunga",
    earlyWithdrawConfirm: "Tarik lebih awal? Bunga hilang, semua bonus aktif (slot/kecepatan) langsung nonaktif.",
    actionFailed: "Aksi gagal, coba lagi",
    notMaturedYet: "Masa belum berakhir",
    alreadyResolved: "Deposito ini sudah ditutup",
  },
  partnerTasks: {
