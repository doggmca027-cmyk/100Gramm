...
const id: typeof ru = {
  ...
  shop: {
    navLabel: "Beli GRAM",
    title: "💎 Toko GRAM",
    subtitle: "Isi ulang saldo dengan TON",
    connectWallet: "Hubungkan dompet untuk membeli",
    buy: "Beli seharga {price} TON",
    preparing: "Menyiapkan pembelian...",
    awaitingWallet: "Konfirmasi di dompetmu...",
    verifying: "Memverifikasi pembayaran on-chain...",
    success: "Selesai! Saldo bertambah {amount} GRAM",
    close: "Tutup",
    cancelled: "Pembayaran dibatalkan",
    errorGeneric: "Gagal menyelesaikan pembelian, coba lagi",
